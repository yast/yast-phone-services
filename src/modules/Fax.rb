...
module Yast
  class FaxClass < Module
    def main
      ...
      @conf_file = "/etc/capisuite/fax.conf"
    ...
    def Write
      ...
      if ret == true
        ...
        command = "if [ -e /opt/kde3/share/config -a ! -e /opt/kde3/share/config/kdeprintfaxrc ]; then " +
          ...
          "echo \"System=hylafax\" >> /opt/kde3/share/config/kdeprintfaxrc; " + "fi"
